...
idle, but not allowed to disable the external-power rail shared with nice_view), NKRO, backlight
(40% at start, auto-off on idle), soft-off, +8dB BLE TX power, and 8ms debounce. Toggle
keyboard-wide features here.
